...
Canonical specification for the OpenAPI contract layer in `apps/api` and the `packages/api-types` typed client. Promoted from `openapi-contract-and-typed-client`.
